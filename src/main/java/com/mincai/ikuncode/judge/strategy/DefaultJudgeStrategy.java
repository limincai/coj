...
public class DefaultJudgeStrategy implements JudgeStrategy {
    ...
    public QuestionJudgeInfo doJudge(JudgeContext judgeContext) {
        ...
        // 判断题目内存和时间限制
        QuestionJudgeInfo executeCodeJudgeInfo = executeCodeResponse.getQuestionJudgeInfo();
        Long executeCodeTime = executeCodeJudgeInfo.getTime();
        Long executeCodeMemory = executeCodeJudgeInfo.getMemory();
